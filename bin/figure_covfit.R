...
figure %<>% fill_panel("surbias.pdf", row=1, column=1:3, scaling = "fit", label_just = "bottom")
figure %<>% fill_panel("gcbias.pdf", row=1, column=4:6, scaling = "fit", label_just = "bottom")
